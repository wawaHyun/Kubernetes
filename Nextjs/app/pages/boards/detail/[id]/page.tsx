...
import { fetchAllBoards, findBoardById } from "@/redux/features/boards/service/board.service";
import { getAllBoards, getFindBoardById } from "@/redux/features/boards/service/board.slice";
...
export default function BoardDetailPage(props: any) {
    ...
    const findBoard = useSelector(getFindBoardById)
